...
class ReclamationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reclamations = $em->getRepository('AssociationBundle:Reclamation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AssociationBundle\Form\ReclamationType', $reclamation);
    ...
    {
        $deleteForm = $this->createDeleteForm($reclamation);
        $editForm = $this->createForm('AssociationBundle\Form\ReclamationType', $reclamation);
